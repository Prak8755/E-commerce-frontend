...
import { fetchAllFilterProductsAsync, fetchAllProductsAsync, selectAllProducts } from "../productSlice";

const sortOptions = [
  { name: "Best Rating",sort:'rating',order:'desc', current: false ,id:'a'},

  { name: "Price: Low to High",sort:'price',order:'desc', href: "#", current: false ,id:'b'},
  { name: "Price: High to Low", sort:'price',order:'asc', current: false ,id:'c'},
];
...
const ProductList = () => {
  ...
  function handleFilter(e,section,option){
    // let newFilter={[section.id]:option.value};
  ...
  return (
    <>
      <div className="bg-white">
        <div>
        <MobileFilter mobileFiltersOpen={mobileFiltersOpen} handleFilter={handleFilter}setMobileFiltersOpen={setMobileFiltersOpen} />
                              ...
                              <div className="mt-4 flex justify-between">
                                <div>
                                  ...
                                  <p className="mt-1 text-sm text-gray-500">
                                    <StarIcon className="h-6 inline "></StarIcon>
...
function MobileFilter({mobileFiltersOpen,handleFilter,setMobileFiltersOpen}){
return (
  <>
