...
//TODO - WE WILL ADD COLORS,SIZE ETC IN OUR OWN API
const colors = [
...
export default function ProductDetails() {
  ...
  function handleCart(e) {
    e.preventDefault();
    const index = cartItems.findIndex((i) => i.productId === product.id);
    if (index < 0) {
      const newItem = {
        ...product,
        quantity: 1,
      ...
      alert.success("Cool,Product is added to the cart");
    } else {
      alert.show("Oops,Product is already added");
    }
  }
